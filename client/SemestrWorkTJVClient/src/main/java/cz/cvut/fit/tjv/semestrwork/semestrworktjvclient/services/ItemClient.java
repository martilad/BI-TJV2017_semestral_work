...
/**
 * Jersey REST client generated for REST resource:ItemsSemFacadeREST [item]<br>
 * USAGE:
 * <pre>
...
public class ItemClient {
    ...
    public <T> T findAllItems_XML(Class<T> responseType) throws javax.ws.rs.ClientErrorException {
        WebTarget resource = webTarget;
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_XML).get(responseType);
    }

    public <T> T findAllItems_JSON(Class<T> responseType) throws javax.ws.rs.ClientErrorException {
        WebTarget resource = webTarget;
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_JSON).get(responseType);
    }
